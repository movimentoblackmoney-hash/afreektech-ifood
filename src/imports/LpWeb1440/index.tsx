...
function Conteudo() {
  return (
    <div className="content-stretch flex h-[44px] items-center justify-between overflow-clip relative shrink-0 w-[1140px]" data-name="Conteúdo">
      <Marcas />
      <div className="bg-[#ea1d2c] content-stretch flex gap-[9px] items-center px-[18px] py-[9px] relative rounded-[8px] shrink-0" data-name="LP/Botão · Primário">
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[13px] text-white tracking-[0.13px] whitespace-nowrap">Quero me inscrever</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0" data-name="Selos">
      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[9px] relative rounded-[999px] shrink-0" data-name="LP/Selo de confiança">
        ...
        <p className="[word-break:break-word] font-['Archivo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7cbd4] text-[15px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
          ✅
        </p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c7cbd4] text-[13px] whitespace-nowrap">Certificado de conclusão</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[9px] relative rounded-[999px] shrink-0" data-name="LP/Selo de confiança">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.16)] border-solid inset-0 pointer-events-none rounded-[999px]" />
        <p className="[word-break:break-word] font-['Archivo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7cbd4] text-[15px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ...
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c7cbd4] text-[13px] whitespace-nowrap">100% gratuito</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[9px] relative rounded-[999px] shrink-0" data-name="LP/Selo de confiança">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.16)] border-solid inset-0 pointer-events-none rounded-[999px]" />
        <p className="[word-break:break-word] font-['Archivo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7cbd4] text-[15px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ...
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c7cbd4] text-[13px] whitespace-nowrap">Feito pra quem começa do zero</p>
      </div>
    </div>
  );
}
...
function Conteudo1() {
  return (
    <div className="content-stretch flex flex-col gap-[26px] items-start overflow-clip relative shrink-0 w-full" data-name="Conteúdo">
      <Selos />
      ...
      <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#c7cbd4] text-[24px] w-[696px]">
      ...
      <div className="bg-[#ea1d2c] content-stretch flex gap-[9px] items-center px-[32px] py-[16px] relative rounded-[8px] shrink-0" data-name="LP/Botão · Primário">
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[15px] text-white tracking-[0.15px] whitespace-nowrap">QUERO ME INSCREVER GRÁTIS</p>
        <IconArrowRight />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="02 · Hero">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[200px] py-[110px] relative size-full">
          <Conteudo1 />
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute h-[99.87%] left-[0.05%] max-w-none top-[0.02%] w-[99.97%]" src={imgFrame1} />
        </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[24px] items-start justify-center relative shrink-0 w-full">
      <Conteudo2 />
      <div className="h-[390px] relative shrink-0 w-[381px]" data-name="Rectangle">
...
function Component03GanchoIdentificacao() {
  return (
    <div className="bg-black relative shrink-0 w-full" data-name="03 · Gancho / Identificação">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[200px] py-[96px] relative size-full">
          <Frame2 />
        </div>
      </div>
    </div>
...
function Label1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center overflow-clip relative shrink-0" data-name="Label">
      ...
      <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c8d44a] text-[11px] tracking-[1.1px] whitespace-nowrap">O CURSO</p>
    </div>
  );
}
...
function Conteudo3() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip relative shrink-0 w-full" data-name="Conteúdo">
      <Cabecalho />
      <Jornada />
    </div>
  );
...
function Cabecalho1() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center overflow-clip relative shrink-0 w-full" data-name="Cabeçalho">
      <Label2 />
      <p className="[word-break:break-word] font-['Changa:ExtraBold',sans-serif] font-extrabold leading-[0] not-italic relative shrink-0 text-[#e5e7eb] text-[44px] text-center whitespace-nowrap">
  ...
  return (
    <div className="bg-[#ea1d2c] relative rounded-[12px] shrink-0 size-[52px]" data-name="Ícone">
      <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Archivo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#e5e7eb] text-[26px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
          📊
        </p>
      </div>
  ...
  return (
    <div className="bg-[#ea1d2c] h-[291px] relative rounded-[12px] shrink-0 w-[328px]" data-name="Card · Fechamento">
      <div className="content-stretch flex flex-col gap-[14px] items-start justify-center overflow-clip px-[30px] py-[32px] relative rounded-[inherit] size-full">
        <div className="[word-break:break-word] font-['Archivo:Black',sans-serif] font-black leading-[0] relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ...
        <div className="bg-[#ea1d2c] content-stretch flex gap-[9px] items-center px-[22px] py-[12px] relative rounded-[8px] shrink-0" data-name="LP/Botão · Primário">
          <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[13px] text-white tracking-[0.13px] whitespace-nowrap">COMEÇAR AGORA</p>
          <IconArrowRight1 />
        </div>
      </div>
      <div aria-hidden className="absolute border border-[#ea1d2c] border-solid inset-0 pointer-events-none rounded-[12px]" />
  ...
  return (
    <div className="content-start flex flex-wrap gap-[24px] items-start overflow-clip relative shrink-0 w-full" data-name="Grid de pilares">
      <div className="bg-[#1a1a20] content-stretch flex flex-col gap-[14px] h-[291px] items-start px-[30px] py-[32px] relative rounded-[12px] shrink-0 w-[328px]" data-name="LP/Card · Pilar">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <Icone />
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[11px] tracking-[1.32px] whitespace-nowrap">PILAR 01</p>
        <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap">Precificação</p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ea1d2c] text-[13px] whitespace-nowrap">Saiba quanto cobrar</p>
      ...
      <div className="bg-[#1a1a20] content-stretch flex flex-col gap-[14px] h-[291px] items-start px-[30px] py-[32px] relative rounded-[12px] shrink-0 w-[328px]" data-name="LP/Card · Pilar">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <Icone1 />
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[11px] tracking-[1.32px] whitespace-nowrap">PILAR 02</p>
        <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap">MEI</p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c8d44a] text-[13px] whitespace-nowrap">Abra seu CNPJ</p>
      ...
      <div className="bg-[#1a1a20] content-stretch flex flex-col gap-[14px] h-[291px] items-start px-[30px] py-[32px] relative rounded-[12px] shrink-0 w-[328px]" data-name="LP/Card · Pilar">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <Icone2 />
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[11px] tracking-[1.32px] whitespace-nowrap">PILAR 03</p>
        <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap">Acesso a Crédito</p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ea1d2c] text-[13px] whitespace-nowrap">Destrave oportunidades</p>
      ...
      <div className="bg-[#1a1a20] content-stretch flex flex-col gap-[14px] h-[291px] items-start px-[30px] py-[32px] relative rounded-[12px] shrink-0 w-[328px]" data-name="LP/Card · Pilar">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <Icone3 />
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[11px] tracking-[1.32px] whitespace-nowrap">PILAR 04</p>
        <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap">IA na Prática</p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c8d44a] text-[13px] whitespace-nowrap">Use IA no dia a dia</p>
      ...
      <div className="bg-[#1a1a20] content-stretch flex flex-col gap-[14px] h-[291px] items-start px-[30px] py-[32px] relative rounded-[12px] shrink-0 w-[328px]" data-name="LP/Card · Pilar">
        <div aria-hidden className="absolute border border-[rgba(255,255,255,0.09)] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <Icone4 />
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Heavy',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[11px] tracking-[1.32px] whitespace-nowrap">PILAR 05</p>
        <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#e5e7eb] text-[19px] whitespace-nowrap">Vitrine Digital</p>
        <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ea1d2c] text-[13px] whitespace-nowrap">Coloque seu negócio online</p>
...
function Conteudo4() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start overflow-clip relative shrink-0 w-full" data-name="Conteúdo">
      <Cabecalho1 />
      <GridDePilares />
    </div>
  );
...
function Label3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center overflow-clip relative shrink-0" data-name="Label">
      ...
      <p className="[word-break:break-word] font-['Archivo:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#c8d44a] text-[11px] tracking-[1.1px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        POR QUE CONFIAR
      </p>
    </div>
  );
...
function Texto() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20px] items-start min-w-px overflow-clip relative" data-name="Texto">
      <Label3 />
      <div className="[word-break:break-word] font-['Changa:ExtraBold',sans-serif] font-extrabold leading-[0] not-italic relative shrink-0 text-[#e5e7eb] text-[40px] whitespace-nowrap">
...
function Reforco() {
  return (
    <div className="content-stretch flex gap-[14px] h-[169px] items-start overflow-clip relative shrink-0 w-full" data-name="Reforço">
...
function Cabecalho2() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center overflow-clip relative shrink-0 w-full" data-name="Cabeçalho">
      <Label4 />
      <div className="[word-break:break-word] font-['Changa:ExtraBold',sans-serif] font-extrabold leading-[0] not-italic relative shrink-0 text-[#e5e7eb] text-[44px] text-center whitespace-nowrap">
...
function Linha() {
  return (
    <div className="content-stretch flex gap-[14px] h-[129px] items-start overflow-clip relative shrink-0 w-full" data-name="Linha">
...
function Passos() {
  return (
    <div className="content-stretch flex gap-[14px] h-[178px] items-start overflow-clip relative shrink-0 w-full" data-name="Passos">
...
function Conteudo7() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start overflow-clip relative shrink-0 w-[1140px]" data-name="Conteúdo">
      <Cabecalho3 />
      <Passos />
    </div>
  );
...
function FilledPortion() {
  return <div className="bg-[#ea1d2c] h-full relative shrink-0 w-[320px]" data-name="Filled Portion" />;
}
...
function SliderSection() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Slider Section">
      <p className="[word-break:break-word] font-['Fivo_Sans_Modern:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b616f] text-[12px] tracking-[0.6px] whitespace-nowrap">HÁ QUANTO TEMPO VOCÊ É ENTREGADOR?</p>
      <SliderContainer />
    </div>
  );
}
          ...
          <div className="bg-[#ea1d2c] relative rounded-[8px] shrink-0 w-full" data-name="LP/Botão · Primário">
            <div className="flex flex-row items-center justify-center size-full">
              <div className="content-stretch flex gap-[9px] items-center justify-center px-[32px] py-[16px] relative size-full">
                <p className="[word-break:break-word] font-['Bomstad_Display:Black',sans-serif] leading-[normal] not-italic relative shrink-0 text-[15px] text-white tracking-[0.15px] whitespace-nowrap">GARANTIR MINHA VAGA GRÁTIS</p>
                <IconArrowRight2 />
              </div>
            </div>
          </div>
...
function Conteudo8() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[1140px]" data-name="Conteúdo">
      <Colunas1 />
    </div>
  );
}
...
function Marca2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center overflow-clip relative shrink-0" data-name="Marca">
      <MarcaAfreektech1 />
      <p className="[word-break:break-word] font-['Archivo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#5b616f] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Links() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Archivo:Medium',sans-serif] font-medium gap-[24px] items-center leading-[normal] overflow-clip relative shrink-0 text-[#5b616f] text-[12px] whitespace-nowrap" data-name="Links">
...
function Conteudo9() {
  return (
    <div className="content-stretch flex items-center justify-between overflow-clip relative shrink-0 w-[1140px]" data-name="Conteúdo">
      <Marca2 />
      <Links />
    </div>
  );
